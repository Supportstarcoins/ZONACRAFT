...
if "bpy.ops.object.select_all(action='DESELECT')" in text:
    raise SystemExit('blocking context-sensitive select_all call remains')
if 'def deselect_all_objects():' not in text:
