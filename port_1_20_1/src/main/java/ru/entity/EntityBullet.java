...
public class EntityBullet extends uh implements un, IParticleEmmiter {
   private int d = -1;
   private int e = -1;
   private int f = -1;
   private int au;
   ...
   public EntityBullet(nn shooter, int damage, boolean aim, float spread, float speedFactor, String hitSound, double damageFactor, float yaw, float pitch) {
      this(shooter.q);
      super.b(shooter.u, shooter.v + shooter.f(), shooter.w, shooter.A, shooter.B);
      float f = 1.0F;
      super.x = -ls.a(super.A / 180.0F * (float) Math.PI) * ls.b(super.B / 180.0F * (float) Math.PI) * f;
      super.z = ls.b(super.A / 180.0F * (float) Math.PI) * ls.b(super.B / 180.0F * (float) Math.PI) * f;
      super.y = -ls.a(super.B / 180.0F * (float) Math.PI) * f;
      this.c(super.x, super.y, super.z, speedFactor, spread);
   ...
   public EntityBullet(
      ...
      this.c(super.x, super.y, super.z, 20.0F, 0.0F);
      this.damageFactor = damageFactor;
      this.shooter = shooter;
      this.av = damage;
      this.hitSound = hitSound;
   ...
   public void l_() {
      ...
      if (!super.q.I) {
         atc vec3 = atc.a(super.u, super.v, super.w);
         atc vec31 = atc.a(this.u + super.x, super.v + super.y, super.w + super.z);
         ...
         float moveX = ls.a(super.x * super.x);
         float moveY = ls.a(super.y * super.y);
         float moveZ = ls.a(super.z * super.z);
      ...
      for (int i = 1; i <= 100; i++) {
         ...
         for (int j = 0; j < list.size(); j++) {
            ...
            if (entity1.L() && (entity1 != entitylivingbase || super.ac >= 5)) {
               axisalignedbb = entity1.E.a(entity1.x, entity1.y, entity1.z);
