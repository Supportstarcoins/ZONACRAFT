...
public class EntityElectraLight extends nn {
   public TileEntityElectra tile;

   public EntityElectraLight(TileEntityElectra tile) {
      super(tile.k);
      this.tile = tile;
      this.a(0.0F, 0.0F);
      super.Z = true;
   ...
   public void l_() {
      super.l_();
      Logger.debug("tick");
      if (this.tile.r() || this.tile.ticksSleep <= 50) {
         this.x();
      }
   }
