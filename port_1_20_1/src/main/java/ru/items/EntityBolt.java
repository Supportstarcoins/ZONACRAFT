...
public class EntityBolt extends nn {
   ...
   public EntityBolt(abw par1World) {
      super(par1World);
   ...
   public EntityBolt(abw par1World, uf shooter, float speedFactor, float explosionSize, String modelName, String textureName, int lifetime) {
      this(par1World);
