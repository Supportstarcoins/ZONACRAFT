...
public final class ArmorZonePatchMod {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        System.out.println("[Zonecraft Armor Zone Patch] PREINIT 1.0.1 OK");
    }

    @Mod.EventHandler
    public void init(FMLInitializationEvent event) {
        MinecraftForge.EVENT_BUS.register(new ZonePatchEvents());
        System.out.println("[Zonecraft Armor Zone Patch] Hit zones and safe tooltip cleanup registered.");
    }
